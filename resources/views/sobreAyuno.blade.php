                        ...
                        <div class="col">
                            <div class="tab-content py-3">
                                <div class="" id="tab1" role="tabpanel">
                                    <h1 class=" display-3 text-center mb-3">Todo (o casi todo) sobre el Ayuno Intermitente</h1>
                                    <div class="anchor"></div>
                                    <img src="{{ asset('assets/img/origenes_ayuno.jpg') }}" class="img-fluid" width="" alt="...">
                                    <hr>
                                    <h3>Los orígenes  del ayuno</h3>
                                    <p>El ayuno intermitente, una práctica que consiste en abstenerse de comer durante ciertos períodos de tiempo, se ha convertido en una tendencia popular en la búsqueda de la salud y el bienestar. Pero, ¿de dónde proviene esta práctica ancestral? Los orígenes del ayuno se remontan a miles de años atrás y tienen una larga tradición en la cultura griega.</p>
                                    <p>En la antigua Grecia, el ayuno era considerado una forma de disciplina espiritual para purificar el alma y alejar a los demonios que se habían apoderado del cuerpo a través de comer en exceso y beber. Los efectos positivos del ayuno también se notaron en la mejora de la salud y en la liberación de energía.</p>
                                    <p>Además, el ayuno se utilizaba como una forma de acercarse a los dioses y abrir la mente a la inspiración divina. Por ejemplo, la pitonisa del oráculo de Delphi fortalecía su mirada en el futuro ayunando. Los filósofos griegos también emplearon el ayuno para mejorar su percepción e inteligencia. Pitágoras, por ejemplo, ayunó durante 40 días antes de sus exámenes y dejó que sus alumnos ayunaran para agudizar su percepción.</p>
                                    <p>El ayuno también tiene un lugar destacado en la religión cristiana, donde se practica como una forma de arrepentimiento y de mostrar solidaridad por los demás. Los cristianos ayunan durante la Cuaresma para recordar el sacrificio de Jesús y expresar su gratitud.</p>
                                    <p>Durante el Renacimiento, el ayuno se utilizó como una alternativa a la medicina tradicional y se empleó para tratar enfermedades como el cáncer y la diabetes. En la actualidad, el ayuno intermitente se ha convertido en una forma de vida para muchas personas, que lo practican con el objetivo de mejorar su salud y bienestar y vivir una vida más sana y equilibrada.</p>
                                    <hr>
                                    <img src="{{ asset('assets/img/autofagia.jpg') }}" class="img-fluid" width="" alt="...">
                                    <div class="anchor"></div>
                                    <hr>
                                    <h3>La Autofagia y el Rejuvenecimiento Celular</h3>
                                    <p>La palabra, derivada del griego, hace referencia a la idea de "comerse a uno mismo", que sería el mecanismo por el que las células de nuestro cuerpo se degradan y reciclan sus propios componentes. </p>
                                    <p>En 2016, el japonés Yoshinori Ohsumi recibió el Premio Nobel de Medicina por sus descubrimientos relacionados con la autofagia celular. A pesar de que muchos no estén familiarizados con el término, la autofagia es un proceso crucial para la salud celular y el rejuvenecimiento. Una forma de activar este proceso es a través del ayuno intermitente.</p>
                                    <p>El ayuno intermitente consiste en alternar períodos de alimentación normal con períodos de ayuno. Esta práctica ha demostrado tener beneficios para la salud, como la pérdida de peso, la mejora de la sensibilidad a la insulina y la reducción del riesgo de enfermedades crónicas como la diabetes y la enfermedad cardiovascular.</p>
                                    <p>Además, el ayuno intermitente también ha sido asociado con la activación de la autofagia. Durante el ayuno, el cuerpo utiliza las reservas de glucógeno como fuente de energía, lo que conduce a la privación de nutrientes en las células. Esto activa la vía de la autofagia, lo que permite que las células reciclen componentes celulares dañados o envejecidos para obtener energía.</p>
                                    <p>La activación de la autofagia durante el ayuno intermitente puede tener efectos beneficiosos en la salud y el envejecimiento. Se ha demostrado que el ayuno intermitente mejora la función cognitiva y reduce la aparición de enfermedades neurodegenerativas en ratones. Además, el ayuno intermitente también puede reducir la inflamación y mejorar la salud cardiovascular.</p>
                                    <p>Sin embargo, es importante tener en cuenta que el ayuno intermitente no es adecuado para todas las personas y se debe realizar con precaución. Las personas con ciertas condiciones médicas, como la diabetes, pueden experimentar hipoglucemia durante el ayuno y deben consultar con un profesional médico antes de comenzar esta práctica. Además, es importante asegurarse de que se están consumiendo suficientes nutrientes durante los períodos de alimentación para evitar deficiencias nutricionales.</p>
                                    <hr>
                                    <img src="{{ asset('assets/img/ayuno_diferencias.jpg') }}" class="img-fluid" width="" alt="...">
                                    <hr>
                                    <div class="anchor" ></div>
                                    <h3>Diferencia entre ayuno e inanición</h3>
                                    <p>El ayuno es una práctica cada vez más popular en la sociedad actual debido a los beneficios que se le atribuyen para la salud. Sin embargo, es importante entender la diferencia entre el ayuno y la inanición para evitar poner en riesgo nuestro organismo. En este artículo explicaremos la diferencia entre ambos términos y cómo hacer un ayuno de forma responsable y efectiva.</p>
                                    <div class="pl-4">
                                        <div class="anchor" ></div>
                                        <h6>¿Qué es el ayuno?</h6>
                                        <p>El ayuno se define como la abstinencia voluntaria del alimento durante un período determinado de tiempo. Durante este período, el organismo comienza a consumir sus reservas de grasa y músculo, sin afectar las estructuras de los órganos vitales como el corazón, cerebro, pulmones y sistema nervioso.</p>
                                        <div class="anchor" ></div>
                                        <h6>¿Cuál es la diferencia entre ayuno e inanición?</h6>
                                        <p>La inanición es el período posterior al ayuno, cuando este se prolonga anormalmente. Si el organismo agota sus reservas, comenzará a consumir los órganos vitales antes mencionados, llevando a la muerte. Por lo tanto, el ayuno prolongado o irresponsable puede llevar a la inanición, lo cual es peligroso para la salud.</p>
                                    </div>
                                    <hr>
                                    <img src="{{ asset('assets/img/empezar.jpg') }}" class="img-fluid" width="" alt="...">
                                    <hr>
                                    <div class="anchor"></div>
                                    <h3>¿Cómo empezar con el Ayuno intermitente?</h3>
                                    <p>Puede ser un desafío saber por dónde empezar a realizar esta sana práctica. Esta es una guía para principiantes, para entender lo que es el Ayuno Intermitente y cómo puedes empezar a hacerlo de forma segura y efectiva.</p>
                                    <ul class="list-unstyled">
                                        <ul>
                                          <li>Elige un método que se adapte a ti: Como se mencionó anteriormente, hay varios métodos de Ayuno Intermitente. Elige el que mejor se adapte a tu estilo de vida y objetivos.</li><br>
                                          <li>Comienza lentamente: Si nunca has ayunado antes, es importante comenzar lentamente. Empieza por ayunar durante 12 horas y luego aumenta gradualmente la duración de tu ayuno.</li><br>
                                          <li>Hidrátate: Durante el ayuno, es importante mantenerse hidratado. Bebe mucha agua, té o café sin azúcar.</li><br>
                                          <li>No te excedas en la comida: Cuando rompas tu ayuno, no te excedas en la comida. Comienza con comidas ligeras y saludables y aumenta gradualmente tu ingesta calórica a medida que tu cuerpo se adapte.</li><br>
                                          <li>Sé consistente: La consistencia es clave cuando se trata de Ayuno Intermitente. Intenta mantener un horario de ayuno y alimentación constante para obtener mejores resultados.</li>
                                        </ul>
                                    </ul>
                                    <hr>
                                    <img src="{{ asset('assets/img/preguntas-respuestas.jpg') }}" class="img-fluid" width="" alt="...">
                                    <hr>
                                    <div class="anchor" id="tiposAyuno"></div>
                                        <h3>Los diferentes tipos de Ayuno</h3>
                                        <p>El ayuno intermitente se ha convertido en una práctica muy popular en los últimos años debido a sus múltiples beneficios para la salud. Una de las ventajas más interesantes es que existen diferentes tipos de ayuno, por lo que es posible elegir el que mejor se adapte a las necesidades y preferencias de cada persona.</p>
                                        <p><strong>Ayuno intermitente 12:12</strong>:<br> Uno de los tipos de ayuno más sencillos es el ayuno intermitente 12:12. Como su nombre indica, se trata de ayunar durante 12 horas al día y comer en las 12 horas restantes. Esta opción es ideal para quienes quieren mejorar su consciencia alimentaria y mantener su masa muscular, pero no llegará a la cetosis.</p>
                                        <p><strong>Ayuno intermitente 16:8</strong>:<br> Otro tipo de ayuno intermitente muy popular es el 16:8, que consiste en ayunar durante 16 horas al día y comer en las 8 horas restantes. Durante el ayuno, se pueden tomar bebidas sin calorías. Una de las ventajas de esta modalidad es que permite llegar a la cetosis, lo que ayuda a quemar grasas de forma eficiente y a regular el nivel de azúcar en sangre.</p>
                                        <p><strong>Ayuno intermitente 18:6</strong>:<br> Si se quiere aumentar la duración del ayuno, se puede optar por el ayuno intermitente 18:6. En este caso, se ayuna durante 18 horas al día y se come en las 6 horas restantes. Es importante planificar bien las comidas para no sufrir mareos o desequilibrios nutricionales.</p>
                                        <p><strong>Ayuno intermitente 20:4</strong>:<br> Para quienes buscan un ayuno más estricto, está el ayuno intermitente 20:4. En este caso, se ayuna durante 20 horas al día y se come en las 4 horas restantes. Esta opción es muy efectiva para la autofagia, un proceso mediante el cual las células se regeneran, pero no se recomienda para personas con predisposición a trastornos de la conducta alimentaria.</p>
                                        <p><strong>Ayuno de un día</strong>:<br> Por último, está el ayuno de un día, que consiste en no comer nada durante 24 horas consecutivas. Esta práctica es muy beneficiosa para reducir la inflamación y aumentar el efecto antioxidante del organismo, pero es importante consultar con un médico antes de realizarlo.</p>
                                        <div class="anchor"></div>
                                        <hr>
                                        <img src="{{ asset('assets/img/romper-ayuno.jpg') }}" class="img-fluid" width="" alt="...">
                                        <hr>
                                        <h3>Consejos para romper el Ayuno</h3>
                                        <p>Si estás practicando el ayuno intermitente, es importante que sepas cómo romper el ayuno de forma saludable para no dañar tu cuerpo y sacar el máximo provecho a tu dieta. A continuación, te ofrecemos algunos consejos para que sepas qué comer después de tu ayuno.</p>
                                        <p><strong>1. Proteínas</strong></p>
                                        <p>Las proteínas son esenciales para el desarrollo muscular y para mantenerte saciado durante el día. Después de pasar horas sin comer, lo ideal es elegir proteínas sin grasas y de alto valor biológico como carnes magras, pavo, pollo, pescado y huevos.</p>
                                        <p>Los huevos son una excelente opción si tu ayuno finaliza en horas de la mañana, ya que te aportarán energía y muchos nutrientes para comenzar el día. Además, puedes combinarlos con vegetales, panes integrales o versiones alternativas de panes como el pan de berenjena o el pan de aguacate y calabacín.</p>
                                        <p><strong>2. Grasas saludables</strong></p>
                                        <p>Las grasas cumplen funciones esenciales dentro del organismo, por lo que se acoplan muy bien a nuestra primera comida post-ayuno, pero es importante tener cuidado. No se trata de consumir alimentos fritos en aceites saturados, sino de complementar el plato con grasas saludables de origen vegetal como el aguacate, el aceite de coco, el aceite de oliva extra virgen, frutos secos (nueces, almendras, avellanas) y semillas (lino, sésamo, quínoa, calabaza).</p>
                                        <p><strong>3. Carbohidratos</strong></p>
                                        <p>Los carbohidratos son la principal fuente de energía del cuerpo, por lo que es importante incluirlos en la primera comida después del ayuno, aunque debes reducir la porción y seleccionar panes y cereales integrales (avena, cebada, etc.), frutas y miel.</p>
                                        <p>Recuerda que existen alimentos que debes evitar después de un ayuno intermitente:</p>
                                        <ul>
                                            <li><strong>Azúcar:</strong> evita alimentos azucarados como la bollería, el pan blanco, las galletas, los pasteles, los zumos y los yogures azucarados, ya que aumentan la glucosa en la sangre, fomentando la inflamación y la resistencia a la insulina.</li>
                                            <li><strong>Alimentos procesados:</strong> evita enlatados, bebidas energéticas, carnes procesadas, alimentos congelados y embutidos, ya que no aportan ningún nutriente y contienen aditivos, químicos y conservantes que pueden afectar la salud.</li>
                                            <li><strong>Alcohol:</strong> evita el consumo de alcohol después de un ayuno, ya que proporciona altas concentraciones tóxicas que pasan directo al sistema circulatorio.</li>
                                            <li><strong>Exceso de fibra:</strong> debes regular la ingesta de fibra después de culminar el ayuno, ya que si te excedes, podrías provocar inflamaciones, dolor abdominal y trastornos intestinales.</li>
                                        </ul>
                                    <hr>
